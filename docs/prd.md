...
| **Reading Practice Visual Alignment** | ✅ Complete | Design token alignment, unified radii, GroupPills styling sync, Pattern label removal, label fallback fix. See [`reading-practice-visual-alignment_20260605`](../conductor/archive/reading-practice-visual-alignment_20260605/)                                                                                                                                            |
...
| **Drizzle SQL Migration Workflow**    | ✅ Complete | Migration from `drizzle-kit push` to `drizzle-kit generate` + `drizzle-kit migrate` with auto-migration on server startup, version-controlled migration SQL files, and updated `package.json` scripts. See [`sql_migrations_20260607`](../conductor/archive/sql_migrations_20260607/)                                                                                     |
